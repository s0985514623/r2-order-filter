...
const APP_DOMAIN = 'r2_order_filter_data' as string
export const snake = window?.[APP_DOMAIN]?.env?.SNAKE || 'r2_order_filter'
export const appName = window?.[APP_DOMAIN]?.env?.APP_NAME || 'R2 Order Filter'
